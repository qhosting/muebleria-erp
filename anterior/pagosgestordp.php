...
if ($connect) {
    // A. Consulta de PAGOS (DP) - Filtro añadido aquí
    $query = "SELECT * FROM pagos WHERE fechap BETWEEN '$start_date' AND '$end_date' AND cod_cliente LIKE 'DP%'";
    if (!empty($gestor)) {
...
<head>
    <title>Reporte de Pagos(DP)</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="card no-print">
            <div class="card-header">Resumen por Agente de Cobro (DP)</div>
            <div class="card-body">
                <div class="table-responsive">
                    <table id="resumenGestores"
    ...
    <script>
        ...
        document.getElementById('btnExport').addEventListener('click', function () {
            ...
            // Descargar archivo
            XLSX.writeFile(wb, "reporte_pagos_dp.xlsx");
        });
    </script>
</body>
