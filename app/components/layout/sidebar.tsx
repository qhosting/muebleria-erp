...
const navigation: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: 'Proyección Semanal', href: '/dashboard/reportes/cobranza-semanal', icon: TrendingUp },
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: 'Ventas Registradas', href: '/dashboard/ventas/registradas', icon: ShoppingBag },
