...
const CACHE_NAME = 'vertexerp-v2.9.32';
const urlsToCache = [
  '/',
  '/login',
  '/dashboard',
...
self.addEventListener('install', (event) => {
  console.log('[SW] Instalando Service Worker v2.9.32');
  event.waitUntil(
    caches.open(CACHE_NAME)
      .then((cache) => {
        console.log('[SW] Cache VertexERP v2.9.32 abierto');
...
self.addEventListener('activate', (event) => {
  console.log('[SW] Activando Service Worker v2.9.32');
  event.waitUntil(
