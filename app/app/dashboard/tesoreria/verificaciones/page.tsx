            ...
            <div className="space-y-6">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    ...
                    <div className="flex gap-2">
                        <Button onClick={handlePrintList} variant="outline" className="border-slate-200 text-slate-700 hover:bg-slate-50 shadow-sm">
                    ...
                    <CardContent className="pt-6">
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div className="space-y-2">
                                <Input type="date" value={fechaDesde} onChange={(e: any) => setFechaDesde(e.target.value)} />
                            </div>
                            <div className="space-y-2">
                                <Input type="date" value={fechaHasta} onChange={(e: any) => setFechaHasta(e.target.value)} />
                            </div>
                        </div>
                    </CardContent>
                </Card>
                                        ...
                                        verificaciones.map((v: any) => (
                                            <tr key={v.id} className="hover:bg-gray-50/50 transition-colors">
                                                ...
                                                <td className="px-4 py-3">
                                                    <p className="font-medium text-gray-900">{v.cliente?.nombreCompleto || v.detallesExtra?.nombreCliente || "Desconocido"}</p>
                                                    <p className="text-xs text-gray-500 font-mono">{v.cliente?.codigoCliente || v.detallesExtra?.codigoCliente || "-"}</p>
                                                </td>
                                                <td className="px-4 py-3 max-w-xs">
                                                    <p className="truncate text-gray-600" title={v.cliente?.direccionCompleta || v.detallesExtra?.direccion}>
